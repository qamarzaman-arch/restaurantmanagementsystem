...
AppId={{D3B2A1E9-4C5D-4E3F-8G7H-9I0J1K2L3M4N}
AppName={#MyAppName}
...
[Run]
Filename: "{app}\\{#MyAppExeName}"; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, '&', '&&')}}"; Flags: nowait postinstall skipfsymbols
